...
const fozzieBear = function () {
    console.log("Wocka Wocka!");
}
fozzieBear(); // prints "Wocka Wocka!"
...
rainbowConnection = () => `Someday we'll find it. The Rainbow Connection. The Rainbow Connection. The lovers, the dreamers and me`;
...
//No. It is within the scope of the function.
...
const uppers = newMuppetMovies.map(movie => movie.toUpperCase());
...
const oldMuppetMovies = [
    "The Muppet Movie", //16
    "The Muppets Take Manhattan", //26
    "The Great Muppet Caper", //22
    "The Muppet Christmas Carol", //26
    "Muppet Treasure Island", //22
    "Muppets From Space" //18
];
...
oldMuppetMovies.filter(twoMovies => twoMovies.length === 22);

const anon = oldMuppetMovies.filter(twoMovies => twoMovies.length === 22);
console.log(anon);
...
// randomMuppet=characters => {
    ...
    // randomMuppet(Math.floor(Math.random() * characters.length);
